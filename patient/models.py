...
class PatientData(models.Model):
    ...
    symmetric_polymicrogyria = models.BooleanField(blank=True, null=True)
    ...
    polycystic_brain = models.BooleanField(blank=True, null=True)
    after_stroke = models.BooleanField(blank=True, null=True)
